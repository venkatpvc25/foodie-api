...
public class RazorpaySplitPaymentService {
    ...
    public RazorpayTransferPlan planTransfers(Order order) {
        ...
        if (restaurantAccountId == null || restaurantAccountId.isBlank()) {
            throw new BusinessException(ErrorCode.VALIDATION_ERROR, "Restaurant Razorpay linked account is not configured");
        }
        ...
        Long adminTransferAmount = adminAccountId == null || adminAccountId.isBlank()
                ? 0L
